...
* Update the Spine source files to the supported version
    - The runtime is based on Spine 4.3.xx

    - NOTE: Re-export the JSON with Spine 4.3. Spine 4.2 JSON is not compatible with the 4.3 runtime.
